...
class MyZKApp extends ZKApp {
  ...
  static ZKNode _node;
  static ZKRect _rect;
  static ZKSprite _dino;
  static ZKSprite _bigboy;
  static ZKText _text;
  static ZKScene _scene;
  static ZKGraphic _graphic;
  static ZKContainer _container;
  static bool _loaded = false;
  static double _index = 0;

  List<dynamic> list = [_node, _rect, _dino, _bigboy, _text, _scene, _graphic, _container, _loaded, _index];
    ...
    stage.onTapDown = (event) {
      if (!_state) {
      ...
      else
        {
          ...
          // tween text
          ZKTween(_text.position).to({"x": event.dx, "y": event.dy}, 2000).easing(
              Ease.elastic.easeOut).start();
